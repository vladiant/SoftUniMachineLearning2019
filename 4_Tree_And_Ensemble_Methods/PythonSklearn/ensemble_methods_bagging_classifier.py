...
(
    ...
    wine_class_train,
    wine_class_test,
) = model_selection.train_test_split(wine_features, wine_class, stratify=wine_class)
...
base_results = model_selection.cross_val_score(
    base_cls, wine_features, wine_class, cv=kfold
)
...
print(
    "Train base f1 score: ",
    f1_score(wine_class_train, base_cls.predict(wine_features_train), average="macro"),
)
print(
    "Test base f1 score: ",
    f1_score(wine_class_test, base_cls.predict(wine_features_test), average="macro"),
)
...
model = BaggingClassifier(
    base_estimator=base_cls, n_estimators=num_trees, random_state=seed
)
...
print(
    "Train f1 score: ",
    f1_score(wine_class_train, model.predict(wine_features_train), average="macro"),
)
print(
    "Test f1 score: ",
    f1_score(wine_class_test, model.predict(wine_features_test), average="macro"),
)
